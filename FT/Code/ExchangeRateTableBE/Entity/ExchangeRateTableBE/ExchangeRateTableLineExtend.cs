...
namespace ExchangeRateTableBE {
	...
	public partial class ExchangeRateTableLine{
		...
		*/	
		...
		private  static ExchangeRateTableLine CreateDefault_Extend(ExchangeRateTableBE.ExchangeRateTable parentEntity) {
